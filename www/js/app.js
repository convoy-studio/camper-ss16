...
exports['default'] = function (parent, onMouseEnter, onMouseLeave, previewObj) {
	var scope;
...
var Diptyque = (function (_Page) {
	...
	function Diptyque(props) {
		...
		this.preview = {
			next: _AppStore2['default'].getPreviewUrlByHash(nextDiptyque),
			previous: _AppStore2['default'].getPreviewUrlByHash(previousDiptyque)
		};
	...
	_createClass(Diptyque, [{
		...
		value: function componentDidMount() {
			...
			this.arrowsWrapper = (0, _arrowsWrapper2['default'])(this.element, this.onArrowMouseEnter, this.onArrowMouseLeave, this.preview);
